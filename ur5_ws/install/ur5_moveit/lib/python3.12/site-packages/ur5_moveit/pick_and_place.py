...
class PickAndPlace(Node):
    def __init__(self):
        ...
        self.GRIPPER_CLOSE = 0.4
        
        self.GRIPPER_LENGTH = 0.21
        ...
        self.cube_positions = [
            {'name': 'blue_cube_1', 'x': 0.45, 'y': 0.1, 'z': 0.34},
            {'name': 'blue_cube_2', 'x': 0.5, 'y': 0.0, 'z': 0.34},
            {'name': 'blue_cube_3', 'x': 0.55, 'y': -0.1, 'z': 0.34},
        ]
    ...
    def place(self, cube_name: str) -> bool:
        ...
        if not self.move_to_pose(self.create_pose(x, y, z + 0.15), 'above place'):
            return False
